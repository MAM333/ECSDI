...
def register_message():
    ...
    gr = registerAgent(AgenteCL1, DirectoryAgent, AgenteCL1.uri, getMessagesCount())
    return gr
...
def comunicacion():
    ...
    if messageProperties is None:
        ...
        resultadoComunicacion = build_message(
            Graph(), ACL['not-understood'], sender=AgenteCL1.uri, msgcnt=getMessagesCount())
    else:
        ...
        if perf != ACL.request:
            ...
            if accion == ECSDI.LlistaProductos:
                ...
                build_message(
                Graph(), ACL['Recibido'], sender=AgenteCL1.uri, msgcnt=getMessagesCount())
